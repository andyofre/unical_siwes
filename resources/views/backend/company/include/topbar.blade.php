                                ...
                                <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                    ...
                                    <li class="caption-content">
                                        <a href="#" class="iq-user-toggle">
                                            <img src="{{ asset('assets/images/user/07.jpg') }}" class="img-fluid rounded" alt="user">
                                        </a>
                                                        ...
                                                        <div class="profile-header">
                                                            <div class="cover-container ">
                                                                <div class="media align-items-center mb-4">
                                                                    <img src="{{ asset('assets/images/user/07.jpg') }}" alt="profile-bg" class="rounded img-fluid avatar-80">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6  col-6 pr-0">
                                                                    <div class="profile-details text-center">
                                                                        <a href="#" class="iq-sub-card bg-primary-light rounded-small p-2">
                                                            ...
                                                            <div class="personal-details">
                                                                ...
                                                                <div class="row align-items-center mb-2">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <p class="mb-0">Electrical Engineering</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
