...
<html lang="en" dir="">
    <head>
        ...
        <title>Student Dashboard | UNICAL SIWES - @yield('title')</title>
    ...
    <body class="  ">
        ...
        <div class="wrapper">
            ...
            <div class="iq-sidebar  rtl-iq-sidebar sidebar-default ">
                ...
                @include('backend.students.include.sidebar')

            </div>
            <div class="iq-top-navbar rtl-iq-top-navbar ">

                @include('backend.students.include.topbar')
        ...
        <footer class="iq-footer rtl-footer">
            ...
            @include('backend.students.include.footer')
