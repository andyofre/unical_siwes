...
<html lang="en" dir="">
    <head>
        ...
        <title>School Dashboard | UNICAL SIWES - @yield('title')</title>
    ...
    <body class="  ">
        ...
        <div class="wrapper">
            ...
            <div class="iq-sidebar  rtl-iq-sidebar sidebar-default ">
                ...
                @include('backend.school.include.sidebar')

            </div>
            <div class="iq-top-navbar rtl-iq-top-navbar ">

                @include('backend.school.include.topbar')
        ...
        <footer class="iq-footer rtl-footer">
            ...
            @include('backend.school.include.footer')
