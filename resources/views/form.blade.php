            ...
            <form  method="post" action="{{ route('create.student') }}">
                ...
                @include('inc.frontMessage')
                    ...
                    <div class="m-b30">
                        ...
                        <h2 class="m-b30 text-center py-4">Student SIWES Registeration</h2>
                           ...
                           <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <input name="full_name" type="text"  class="form-control  @error('full_name') is-invalid @enderror" placeholder="full_name*" readonly value="{{ $data['name'] }}">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group">
                                    <input name="faculty" type="text" class="form-control"  placeholder="Faculty*"  readonly value="{{ $data['faculty'] }}">
                                </div>
                            </div>

                            <div class="col-md-4 col-sm-4">
                                <div class="form-group">
                                    <input name="department" type="text" class="form-control"  placeholder="Department*" readonly value="{{$data['department']}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <input name="registration_number" type="text" class="form-control"  placeholder="Registeration Number*"  readonly value="{{ $data['registeration_number'] }}">
                                </div>
                            </div>

                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <input name="year" type="text" class="form-control"  placeholder="Year*"  readonly value="{{ $data['level'] }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <input name="email" type="email" class="form-control @error('phone') is-invalid @enderror"  placeholder="Email*">
                                    @error('email')
                                    <small class="text-sm text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <input  name="phone" type="text" class="form-control @error('phone') is-invalid @enderror"  placeholder="Phone Number">
                            ...
                            <div class="col-md-12 ">
                                <button type="submit" class="btn btn-primary btn-lg align-content-center">Register</button>
                            </div>
