...
/** ====================================================================END */	
	...
	function contact_slide_dub(){
		jQuery('.register_button').on('click', function () {	
			jQuery('.register_slide_hide').animate({'right': '0%'});
		});
		jQuery('.register_button_close').on('click', function () {	
			jQuery('.register_slide_hide').animate({'right': '-100%'});
		});		
	}			
